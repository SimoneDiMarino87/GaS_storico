...
export default function VistaClassifiche({ data }) {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-slate-100" style={{ display: 'flex', justifyContent: 'space-between', backgroundColor: 'white', padding: '16px', borderRadius: '12px', border: '1px solid #f1f5f9', maxWidth: '400px', margin: '0' }}>
      ...
      {classifica.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-10 text-center text-slate-500" style={{ backgroundColor: 'white', borderRadius: '12px', border: '1px solid #f1f5f9', overflow: 'hidden', marginTop: '24px', padding: '40px', textAlign: 'center', color: '#64748b' }}>
          Nessuna classifica disponibile per i filtri selezionati.
        </div>
      ) : (
          <div className="bg-white rounded-xl shadow-sm border border-slate-100" style={{ display: 'inline-block', backgroundColor: 'white', borderRadius: '12px', border: '1px solid #f1f5f9', overflow: 'hidden', marginTop: '24px', padding: '0', textAlign: 'left' }}>
            <table className="text-left border-collapse" style={{ width: 'auto', minWidth: '700px', textAlign: 'left', borderCollapse: 'collapse', margin: 0, backgroundColor: 'transparent' }}>
              <thead>
